...
gulp.task('default', function () {
    //监听的文件    监听的任务
    //watch(['src/*.html', 'src/css/*.css', 'src/js/*.js', 'src/scss/*.scss', 'src/img/*.png'], gulp.parallel('uglifyhtml', 'uglifycss', 'babel', 'runsass', 'runimg'));
    watch(['src/js/*.js', 'src/scss/*.scss'], gulp.parallel('babel', 'runsass'));
